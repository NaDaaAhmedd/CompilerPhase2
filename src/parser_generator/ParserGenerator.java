...
public class ParserGenerator {
    ...
    private HashMap<String, NonTerminal>overflow_map;
    ...
    /*public static void main(String[] args) {
        ...
        ArrayList<Component>E1=new ArrayList<>();
        E1.add(E);E1.add(new Terminal("or"));E1.add(new Terminal("T"));
        E.productions.add(E1);
        ArrayList<Component>E2=new ArrayList<>();
        E2.add(E);E2.add(new Terminal("and"));E2.add(new Terminal("T"));
        E.productions.add(E2);
       ArrayList<Component>T=new ArrayList<>();
       T.add(new Terminal("T"));
       E.productions.add(T);
       ParserGenerator p=new ParserGenerator();
       p.non_terminal_map.put(E.name,E);
       p.Leftrecursion();
    }*/
